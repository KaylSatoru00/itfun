          ...
          {activeSection === 'language' && (
            <>
              ...
              <div className="chap-accordion" style={{ marginTop: 24 }}>
                {[
                  { title: 'Bit',  description: 'The smallest unit of measurement in a computer. Came from the word binary digit (0 to 1).' },
                  { title: 'Byte', description: 'Unit of measurement that denotes one character.' },
                ].map((item, i) => (
                  <AccordionItem
                    key={i}
                    title={item.title}
...
export default FacultyChapter2;
